import{d as K,i as O,e as w,n as $,_ as Q}from"./pinia-23cd74c8.js";import{_ as C,a as h}from"./select-7644ee62.js";import{_ as y,a as u}from"./form-868aa07c.js";import{_ as U}from"./dialog-e14c3e6e.js";import{_ as A}from"./checkbox-92947688.js";import{u as L}from"./umy-table.common-c6c88cde.js";import{D as c}from"./DatabaseType-6e1dece4.js";import{S as m,d as p,e as _,i as X,t as z,b,E as J,c as f,a as Z}from"./stringUtil-740fdda0.js";import{i as k}from"./viewUtil-251f7497.js";import{s as Y,e as D}from"./notify-a02cb7cf.js";import{A as P}from"./arrayUtil-33cb7756.js";import"./scrollbar-d9973143.js";import"./index-a16aa39f.js";import"./index-f37b6d04.js";import"./index-3e66c890.js";class R{dropIndex(e,t){throw new Error("Method not implemented.")}showVersion(){return null}showIndex(e,t){return null}createIndex(e){return null}showDatabases(){return null}updateUser(e){return null}showCollations(){return null}showPackages(e){return null}showChecks(e,t){return null}showPartitions(e,t){return null}showActualPartitions(e,t){return null}showForeignKeys(e,t){return null}updateColumnSql(e){throw new Error("Method not implemented.")}showMaterialViews(e,t){return""}showExternalTables(e){return`select foreign_table_name "name",foreign_server_name "server",foreign_server_catalog "server_db" from information_schema.foreign_tables where foreign_table_schema='${e}';`}showEvents(e){return`SELECT EVENT_NAME "name" FROM information_schema.EVENTS where EVENT_SCHEMA='${e}' ORDER BY EVENT_NAME;`}dropEventTemplate(e){return`DROP EVENT IF EXISTS ${e};`}eventTemplate(){return`CREATE EVENT event_name$1
