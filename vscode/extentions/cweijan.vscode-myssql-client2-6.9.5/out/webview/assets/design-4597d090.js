import{d as K,i as O,f as w,n as $,_ as Q}from"./pinia-1d7b60d7.js";import{_ as C,a as h}from"./option-2b881d86.js";import{_ as y,a as u}from"./form-cc198819.js";import{_ as U}from"./dialog-a62448ca.js";import{_ as A}from"./checkbox-afe2fab5.js";import{u as L}from"./umy-table.common-95562b87.js";import{D as c}from"./DatabaseType-6e1dece4.js";import{S as m,d as p,e as _,i as X,t as z,b,E as J,c as f,a as Z}from"./stringUtil-f88f3441.js";import{i as k}from"./viewUtil-96a12b22.js";import{s as Y,e as D}from"./notify-9e6ef7eb.js";import{A as P}from"./arrayUtil-924944e9.js";import"./scrollbar-489068f6.js";import"./index-c9993d94.js";import"./focus-34de79c8.js";import"./checkbox-52e6312f.js";import"./index-f37b6d04.js";import"./index-3e66c890.js";class R{dropIndex(e,t){throw new Error("Method not implemented.")}showVersion(){return null}showIndex(e,t){return null}createIndex(e){return null}showDatabases(){return null}updateUser(e){return null}showCollations(){return null}showPackages(e){return null}showChecks(e,t){return null}showPartitions(e,t){return null}showActualPartitions(e,t){return null}showForeignKeys(e,t){return null}updateColumnSql(e){throw new Error("Method not implemented.")}showMaterialViews(e,t){return""}showExternalTables(e){return`select foreign_table_name "name",foreign_server_name "server",foreign_server_catalog "server_db" from information_schema.foreign_tables where foreign_table_schema='${e}';`}showEvents(e){return`SELECT EVENT_NAME "name" FROM information_schema.EVENTS where EVENT_SCHEMA='${e}' ORDER BY EVENT_NAME;`}dropEventTemplate(e){return`DROP EVENT IF EXISTS ${e};`}eventTemplate(){return`CREATE EVENT event_name$1
...
BEGIN 
    $2
    RETURN x*2;
END;`}}class te extends W{showVersion(){return`SELECT REPLACE(banner,'DM Database Server 64 ','') "server_version"  FROM v$version where rownum=1;`}createIndex(e){const{table:t,column:n="$2"}=e;return`CREATE INDEX ${`${t}_${n}`} ON ${t}(${n});`}dropIndex(e,t){return`DROP INDEX ${t};`}showIndex(e,t){return`SELECT COLUMN_NAME "column_name",INDEX_NAME "index_name" from DBA_IND_COLUMNS WHERE TABLE_OWNER='${e}' and TABLE_NAME='${t}';`}variableList(){return"show global VARIABLES"}statusList(){return"show global status"}processList(){return"show processlist"}addColumn(e,t){return`ALTER TABLE ${e} 
    ADD COLUMN $1 $2;
...
WITH REPLICATION = { 
    ...
    update_time DATE,
    content VARCHAR(255)
);`}}function Te(a){switch(a||(a=c.MYSQL),a){case null:case c.MYSQL:return new G;case c.MARIA_DB:return new ne;case c.MSSQL:return new re;case c.SQLITE:return new j;case c.DUCK_DB:return new ie;case c.REDSHIFT:return new oe;case c.SNOWFLAKE:return new le;case c.PG:return new q;case c.CLICKHOUSE:return new ee;case c.DM:return new te;case c.ORACLE:return new W;case c.CASSANDRA:return new ue;case c.PRESTO:case c.TRINO:return new Ee;case c.HIVE:return new ce;case c.DB2:return new de;case c.MONGO_DB:return new ae;case c.NEO4J:return new se}return new I}class S{constructor(e){this.meta=e,this.dialect=Te(e.dbType),this.wrappedTable=b(this.meta.table,this.meta.dbType,J.Always)}updateTable(e){return this.dialect.updateTable(e)}columnTypes(){return["INTEGER",{label:"VARCHAR",value:"VARCHAR(255)"},{label:"CHAR",value:"CHAR(50)"},"hr","DATE","TIMESTAMP","hr","BOOLEAN","FLOAT","DOUBLE","hr","TEXT","JSON","BLOB"]}strategys(){return["RESTRICT","CASCADE","SET NULL","SET DEFAULT","NO ACTION"]}newColumn(e){const{name:t,type:n,isNotNull:r}=e,s=r?" NOT NULL":"";return`ALTER TABLE ${this.wrappedTable} ADD COLUMN ${b(t,this.meta.dbType)} ${n}${s}`}updateColumn(e){return this.dialect.updateColumnSql({...e,table:this.meta.table,schema:this.meta.schema})}dropColumn(e){return`ALTER TABLE ${this.wrappedTable} DROP COLUMN ${b(e,this.meta.dbType)}`}formatIndexType(e){return e.index_type}indexTypes(){return[{label:"INDEX",value:"INDEX"},{label:"UNIQUE",value:"UNIQUE"}]}dropIndex(e){return this.dialect.dropIndex(this.wrappedTable,e)}showChecks(){return this.dialect.showChecks(this.meta.schema,this.meta.table)}showForeignKeys(){return this.dialect.showForeignKeys(this.meta.schema,this.meta.table)}newForeignKey(e){const{column:t,foreignKeyName:n,refTable:r,refColumn:s,onUpdate:o,onDelete:l}=e,i=o=="NO ACTION"?"":` ON UPDATE ${o}`,E=l=="NO ACTION"?"":` ON DELETE ${l}`;return new m(`ALTER TABLE "${this.meta.table}"`).if(n,()=>`ADD CONSTRAINT ${n}`).if(!n,"ADD").append(`FOREIGN KEY ("${t}") REFERENCES "${r}"("${s}")${i}${E};`).toString()}dropForeignKey(e){return`ALTER TABLE "${this.meta.table}" DROP CONSTRAINT ${e};`}newCheck(e){return`ALTER TABLE ${this.wrappedTable} ADD CHECK (${e});`}dropCheck(e){return`ALTER TABLE ${this.wrappedTable} DROP CONSTRAINT ${e};`}splitColumn(e,t='"'){return e.map(n=>t+n+t).join(",")}}class _e extends S{columnTypes(){return["Int32","String","Float32","hr","Date","DateTime","hr","BOOLEAN","UUID",{label:"Array",value:"Array(String)"},"hr","JSON",{label:"Tuple",value:"Tuple(String)"},{label:"Map",value:"Map(String,String)"}]}newColumn(e){const{name:t,type:n,defaultValue:r,comment:s}=e;return new m(`ALTER TABLE ${this.wrappedTable} ADD COLUMN "${t}" ${n}`).if(!_(r),`DEFAULT ${p(r,n)}`).if(s,`COMMENT '${s}'`).toString()}newIndex(e){const{columns:t}=e;return`ALTER TABLE "${this.meta.table}" ADD INDEX ${t.join("")}_${new Date().getTime()}_index expression TYPE type GRANULARITY value AFTER ${this.splitColumn(t)}`}showForeignKeys(){return null}showChecks(){return null}}class B extends S{newColumn(e){const{name:t,type:n,defaultValue:r,isNotNull:s}=e;return new m(`ALTER TABLE "${this.meta.schema}".${b(this.meta.table,this.meta.dbType)} ADD ${b(t,this.meta.dbType)} ${n}`).if(s,"NOT NULL").if(!_(r),`DEFAULT ${p(r,n)}`).toString()}dropColumn(e){return`ALTER TABLE "${this.meta.schema}".${this.wrappedTable} DROP COLUMN ${b(e,this.meta.dbType)}`}newIndex(e){const{table:t=this.meta.table,columns:n,type:r}=e,s=`${t}_${n.join("_")}_${new Date().getTime()}`;return`CREATE ${r=="UNIQUE"?"UNIQUE":""} INDEX ${s} ON "${this.meta.schema}"."${t}"(${this.splitColumn(n)});`}newCheck(e){return`ALTER TABLE "${this.meta.schema}".${this.wrappedTable} ADD CHECK (${e});`}dropCheck(e){return`ALTER TABLE "${this.meta.schema}".${this.wrappedTable} DROP CONSTRAINT ${e};`}dropForeignKey(e){return`ALTER TABLE "${this.meta.schema}"."${this.meta.table}" DROP CONSTRAINT ${e};`}newForeignKey(e){return super.newForeignKey(e).replace(`"${this.meta.table}"`,`"${this.meta.schema}"."${this.meta.table}"`)}}class Ae extends S{indexTypes(){return[{label:"INDEX",value:"INDEX"},{label:"UNIQUE",value:"UNIQUE"},{label:"FULLTEXT",value:"FULLTEXT"}]}columnTypes(){return["INT",{label:"VARCHAR",value:"VARCHAR(255)"},{label:"CHAR",value:"CHAR(50)"},"hr","DATETIME","TIMESTAMP","DATE","hr","BIT","FLOAT","DOUBLE",{label:"DECIMAL",value:"DECIMAL(10,2)"},"BIGINT","hr","TEXT","JSON","BLOB","BINARY","hr",{label:"ENUM",value:"ENUM('item')"},{label:"SET",value:"SET('item')"}]}newColumn(e){const{name:t,type:n,comment:r,defaultValue:s,isNotNull:o,unsigned:l,zerofill:i}=e;return console.log(e),new m(`ALTER TABLE ${this.wrappedTable} ADD COLUMN \`${t}\` ${n}`).if(l&&l!=0,"UNSIGNED").if(i,"ZEROFILL").if(o,"NOT NULL").if(r,`COMMENT '${r}'`).if(!_(s),`DEFAULT ${p(s,n)}`).toString()}formatIndexType(e){const t=e.index_type.toUpperCase();return t=="BTREE"?e.index_name=="PRIMARY"?"PRIMARY":k(e.isUnique)?"UNIQUE":"KEY":t}newIndex(e){const{type:t="key",columns:n}=e;return`ALTER TABLE \`${this.meta.table}\` ADD ${t} (${this.splitColumn(n,"`")})`}newForeignKey(e){const{column:t,foreignKeyName:n,refTable:r,refColumn:s,onUpdate:o,onDelete:l}=e,i=o=="NO ACTION"?"":` ON UPDATE ${o}`,E=l=="NO ACTION"?"":` ON DELETE ${l}`;return new m(`ALTER TABLE \`${this.meta.table}\``).if(n,()=>`ADD CONSTRAINT ${n}`).if(!n,"ADD").append(`FOREIGN KEY (\`${t}\`) REFERENCES \`${r}\`(\`${s}\`)${i}${E};`).toString()}dropForeignKey(e){return`ALTER TABLE \`${this.meta.table}\` DROP FOREIGN KEY ${e};`}}class Ne extends S{newIndex(e){const{table:t=this.meta.table,columns:n,type:r}=e,s=`${t}_${n.join("_")}_${new Date().getTime()}`;return`CREATE ${r=="UNIQUE"?"UNIQUE":""} INDEX ${s} ON "${t}"(${this.splitColumn(n)})`}newColumn(e){const{name:t,type:n,isNotNull:r,defaultValue:s,comment:o}=e;return new m(`ALTER TABLE ${b(this.meta.table,this.meta.dbType)} ADD ${t} ${n}`).if(!_(s),`DEFAULT ${p(s,n)}`).if(r,"NOT NULL").if(o,`;
COMMENT ON COLUMN ${this.wrappedTable}."${t.toUpperCase()}" is '${o}';`).toString()}newForeignKey(e){const{column:t,foreignKeyName:n,refTable:r,refColumn:s,onUpdate:o,onDelete:l}=e,i=o=="NO ACTION"?"":` ON UPDATE ${o}`,E=l=="NO ACTION"?"":` ON DELETE ${l}`,T=n||`${t}_${r}_${s}_fk_${Math.floor(Math.random()*30)}`;return`ALTER TABLE "${this.meta.table}" ADD CONSTRAINT ${T} FOREIGN KEY ("${t}") REFERENCES ${r}(${s})${i}${E};`}showForeignKeys(){var t;let{schema:e}=this.meta;return(e==null?void 0:e.toLowerCase())==((t=this.meta.user)==null?void 0:t.toLowerCase())&&(e=void 0),this.dialect.showForeignKeys(e,this.meta.table)}}class pe extends S{newColumn(e){const{name:t,type:n,comment:r,defaultValue:s,isNotNull:o}=e,l=this.wrappedTable;return new m(`ALTER TABLE ${l} ADD COLUMN "${t}" ${n}`).if(o,"NOT NULL").if(!_(s),`DEFAULT ${p(s,n)}`).append(";").if(r,`
COMMENT ON COLUMN ${l}."${t}" is '${r}';`).toString()}columnTypes(){return["INTEGER",{label:"VARCHAR",value:"VARCHAR(255)"},{label:"CHAR",value:"CHAR(50)"},"TIMESTAMP","DATE","BOOLEAN","FLOAT","TEXT","JSON","BLOB"]}indexTypes(){return[{label:"INDEX",value:"INDEX"},{label:"UNIQUE",value:"UNIQUE"},{label:"HASH",value:"HASH"}]}newIndex(e){const{table:t=this.meta.table,columns:n,type:r}=e,s=r=="HASH"?"hash":"btree";return`CREATE ${r=="UNIQUE"?"UNIQUE":""} INDEX ${n.join("_")}_${new Date().getTime()}_index ON "${t}" USING ${s} (${this.splitColumn(n)});`}}class Re extends S{newIndex(e){throw new Error("Method not implemented.")}dropForeignKey(e){return`ALTER TABLE "${this.meta.table}" DROP CONSTRAINT "${e}";`}showForeignKeys(){return`select
