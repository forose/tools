import{s as he,h as V,j as G,_ as x,k as O,o as m,a as h,b as C,l as R,f as p,e as i,D as f,w as c,q as L,t as b,E as P,F as y,y as H,I as X,z as be,A as Le,H as Oe,n as ce}from"./app-Bf1EJw8l.js";import{D as d}from"./DatabaseType-LnCwhqHG.js";import{S,i as g,a as Se,b as Me}from"./columnHandler-D5NGKk6j.js";import{g as B,i as Te,w as v,E as $e}from"./wrapper-DvWVam8d.js";import{i as de}from"./viewUtil-BUapkDkR.js";import{c as q}from"./codemirror-my-f36oj.js";import{E as J}from"./index-B_FZe6hO.js";import{E as Z,a as ee}from"./index-j61gtqiN.js";import{E as Ae}from"./index-BtYaA7w7.js";import{E as le,a as se}from"./index-I4QpTbxY.js";import{E as te,a as ne}from"./index-DGGgE9Vn.js";import{E as ae}from"./index-C6Zovpry.js";import{v as K}from"./directive-DSby91Qc.js";import{s as _e,e as z}from"./notify-7ms8YXRV.js";import{E as re}from"./index-87euUeSH.js";import{A as me}from"./arrayUtil-DEAFvlDD.js";import{E as we}from"./index-D4yGan5e.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./index-CslgC0gF.js";import"./index-Dpstq9UH.js";import"./focus-trap-DLD2w1Ia.js";import"./use-global-config-0XpG2_0j.js";import"./use-form-item-DdyI_hvh.js";import"./icon-CZcOhJQp.js";import"./aria-46nDEFyt.js";import"./validator-Di5JEBAH.js";import"./index-CFJCZjdX.js";import"./index-Ds0zupmL.js";import"./flatten-BCYDgirk.js";import"./_baseIteratee-xh2dZROY.js";import"./_initCloneObject-DbrZpPYH.js";import"./isArrayLikeObject-DnFfw4hg.js";import"./index-CXFq46JV.js";import"./index-D_NJ2QbA.js";import"./scroll-DzYU1O0r.js";import"./_baseClone-DEWKTuY-.js";class F{dropIndex(e,t){throw new Error("Method not implemented.")}showVersion(){return null}showIndex(e,t){return null}createIndex(e){return null}showDatabases(){return null}updateUser(e){return null}showCollations(){return null}showPackages(e){return null}showChecks(e,t){return null}showPartitions(e,t){return null}showActualPartitions(e,t){return null}showForeignKeys(e,t){return null}updateColumnSql(e){throw new Error("Method not implemented.")}showMaterialViews(e,t){return""}showExternalTables(e){return`select foreign_table_name "name",foreign_server_name "server",foreign_server_catalog "server_db" from information_schema.foreign_tables where foreign_table_schema='${e}';`}showEvents(e){return`SELECT EVENT_NAME "name" FROM information_schema.EVENTS where EVENT_SCHEMA='${e}' ORDER BY EVENT_NAME;`}dropEventTemplate(e){return`DROP EVENT IF EXISTS ${e};`}eventTemplate(){return`CREATE EVENT event_name$1
...
AS
SELECT * FROM $2`}procedureTemplate(){return"select number from system.numbers where 1=0"}triggerTemplate(){return"select number from system.numbers where 1=0"}dropTriggerTemplate(e){return"select number from system.numbers where 1=0"}functionTemplate(){return"CREATE FUNCTION [func_name] AS (a, b, c) -> a * b * c;"}}class oe{constructor(e){this.param=e,this.afterTablePrefix=`ALTER TABLE "${e.table}"`,this.afterColumnPrefix=`${this.afterTablePrefix} ALTER COLUMN "${e.columnName}"`}genAlterSQL(){const{columnName:e,newColumnName:t}=this.param;return new S("",`
...
GRANT ALL PRIVILEGES ON *.* TO 'username'@'%' WITH GRANT OPTION;`}updateUser(e){return`update mysql.user set 
    ...
    where User = '${e}';
FLUSH PRIVILEGES;
-- since mysql version 5.7, password column need change to authentication_string=PASSWORD("newPassword")`}updateColumn(e,t){var N;const{name:a,type:r,comment:o,nullable:l,defaultValue:E,extra:u,character_set_name:T,collation_name:A}=t;return new S(`ALTER TABLE ${e}`).append(`
	CHANGE ${a} ${a} ${r}`).if(T,`CHARACTER SET ${T}`).if(A,`COLLATE ${A}`).if(l!="YES","NOT NULL").if((N=u==null?void 0:u.toLowerCase())==null?void 0:N.includes("auto_increment"),"AUTO_INCREMENT").if(o,`COMMENT '${o}'`).if(E,`DEFAULT ${E=="CURRENT_TIMESTAMP"?E:`'${E}'`}`).toString()}updateColumnSql(e){return new oe(e).genAlterSQL()}showUsers(){return"SELECT concat(user,'@',host) user FROM mysql.user;"}pingDataBase(e){return e?null:"select 1"}updateTable(e){const{table:t,newTableName:a,comment:r,newComment:o}=e;let l="";return o&&o!=r&&(l=`COMMENT ON TABLE "${t}" IS '${o}';`),a&&t!=a&&(l+=`RENAME TABLE "${t}" TO "${a}";`),l}truncateDatabase(e){return`SELECT Concat('TRUNCATE TABLE "',table_schema,'"."',TABLE_NAME, '";') trun FROM INFORMATION_SCHEMA.TABLES where  table_schema ='${e}' and TABLE_TYPE<>'VIEW';`}createDatabase(e){return"CREATE DATABASE $1;"}showTableSource(e,t){return`SHOW CREATE TABLE ${e}.${t};`}showViewSource(e,t,a){return`SHOW CREATE VIEW database.${t};`}showProcedureSource(e,t){return`SHOW CREATE PROCEDURE database.${t};`}showFunctionSource(e,t,a){return`SHOW CREATE FUNCTION database.${t};`}showTriggerSource(e,t){return`SHOW CREATE TRIGGER database.${t};`}showColumns(e,t){return`SELECT COLUMN_NAME name,DATA_TYPE simpleType, DATA_TYPE type, IS_NULLABLE nullable 
...
ALTER USER $1 quota unlimited on USERS;
        `}updateUser(e){return`ALTER USER ${e} IDENTIFIED BY [new_password]`}updateColumn(e,t){const{name:a,type:r,comment:o,nullable:l,defaultValue:E}=t;return`-- change column type
ALTER TABLE ${e} MODIFY ${a} ${r};
-- change column name
ALTER TABLE ${e} RENAME COLUMN ${a} TO [newColumnName];
COMMENT ON COLUMN ${e}.${a} IS '${o||""}'`}updateColumnSql(e){const{columnName:t,columnType:a,newColumnName:r,comment:o,defaultValue:l,table:E,isNotNull:u,oldRow:T}=e;return new S("","").if(a!=T.type,`ALTER TABLE "${E}" MODIFY "${t}" ${a};`).if(u!=T.isNotNull,`
ALTER TABLE "${E}" MODIFY "${t}"${u?"NOT NULL":"NULL"};`).if(l!=null&&l!=T.defaultValue,`
ALTER TABLE "${E}" MODIFY "${t}" DEFAULT ${l!=null&&l.match(/(:|nextval)/i)?l:`'${l==null?void 0:l.replace(/(^'|'$)/g,"")}'`};`).if(o&&o!=T.comment,`
COMMENT ON COLUMN "${E}"."${t}" is '${o}';`).if(t!=r,`
ALTER TABLE "${E}" RENAME COLUMN "${t}" TO "${r}";`).toString()}showUsers(){return'SELECT username "user" FROM all_users'}pingDataBase(e){return e?`ALTER SESSION SET current_schema = "${e}"`:"select 1"}updateTable(e){const{table:t,newTableName:a,comment:r,newComment:o}=e;let l="";return o&&o!=r&&(l=`COMMENT ON TABLE "${t}" IS '${o}';`),a&&t!=a&&(l+=`ALTER TABLE "${t}" RENAME TO "${a}"`),l}truncateDatabase(e){return`SELECT 'TRUNCATE TABLE "' || owner || '"."' || object_name || '";' trun FROM all_objects where  owner ='${e}' and object_type ='TABLE'`}createDatabase(e){return"CREATE USER $1 IDENTIFIED BY password$2;"}showTableSource(e,t){return""}showViewSource(e,t,a){return a.isMaterial()?`select QUERY "Create View" from ALL_MVIEWS where OWNER='${e}' and mview_name='${t}'`:`SELECT 'CREATE VIEW ' || view_name || ' AS
...
END;`}}class fe extends Ne{showVersion(){return`SELECT REPLACE(banner,'DM Database Server 64 ','') "server_version"  FROM v$version where rownum=1;`}createIndex(e){const{table:t,column:a="$2"}=e;return`CREATE INDEX ${`${t}_${a}`} ON ${t}(${a});`}dropIndex(e,t){return`DROP INDEX ${t};`}showIndex(e,t){return`SELECT COLUMN_NAME "column_name",INDEX_NAME "index_name" from DBA_IND_COLUMNS WHERE TABLE_OWNER='${e}' and TABLE_NAME='${t}';`}variableList(){return"show global VARIABLES"}statusList(){return"show global status"}processList(){return"show processlist"}addColumn(e,t){return`ALTER TABLE ${e} 
    ADD COLUMN $1 $2;
COMMENT ON COLUMN ${e}.$3 IS 'comment$4';`}createUser(){return"CREATE USER $1 IDENTIFIED BY [password]$2;"}updateUser(e){return`ALTER USER ${e} IDENTIFIED BY [new_password];`}updateColumn(e,t){const{name:a,type:r,comment:o,nullable:l,defaultValue:E}=t;return`-- change column type
ALTER TABLE ${e} MODIFY ${a} ${r};
-- change column name
ALTER TABLE ${e} RENAME COLUMN ${a} TO [newColumnName];
COMMENT ON COLUMN ${e}.${a} IS '${o||""}';`}updateColumnSql(e){const{columnName:t,columnType:a,newColumnName:r,comment:o,defaultValue:l,table:E,isNotNull:u,oldRow:T}=e;return new S("","").if(a!=T.type,`ALTER TABLE "${E}" MODIFY "${t}" ${a};`).if(u!=T.isNotNull,`
...
ALTER TABLE "${E}" MODIFY "${t}" DEFAULT ${l!=null&&l.match(/(:|nextval)/i)?l:`'${l==null?void 0:l.replace(/(^'|'$)/g,"")}'`};`).if(o&&o!=T.comment,`
COMMENT ON COLUMN "${E}"."${t}" is '${o}';`).if(t!=r,`
ALTER TABLE "${E}" RENAME COLUMN "${t}" TO "${r}";`).toString()}showUsers(){return'SELECT username "user" FROM all_users'}pingDataBase(e){return e?`set SCHEMA ${e}`:"select 1"}updateTable(e){const{table:t,newTableName:a,comment:r,newComment:o}=e;let l="";return o&&o!=r&&(l=`COMMENT ON TABLE "${t}" IS '${o}';`),a&&t!=a&&(l+=`ALTER TABLE "${t}" RENAME TO "${a}"`),l}truncateDatabase(e){return`SELECT Concat('TRUNCATE TABLE \`',table_schema,'\`.\`',TABLE_NAME, '\`;') trun FROM INFORMATION_SCHEMA.TABLES where  table_schema ='${e}' and TABLE_TYPE<>'VIEW';`}createDatabase(e){return"CREATE USER [name] IDENTIFIED BY [password];"}showTableSource(e,t){return`CALL SP_TABLEDEF('${e}', '${t}');`}showViewSource(e,t){return`CALL SP_VIEWDEF('${e}', '${t}');`}showProcedureSource(e,t){return`SELECT LISTAGG(text) within group(order by line) "Create Procedure"
        FROM all_source
       WHERE owner = '${e}'
         AND name  = '${t}'
...
GRANT ALL PRIVILEGES ON *.* TO '$1'@'%' WITH GRANT OPTION;`}updateUser(e){return`update mysql.user set 
    ...
    where User = '${e}';
FLUSH PRIVILEGES;
-- since mysql version 5.7, password column need change to authentication_string=PASSWORD("newPassword")`}updateColumn(e,t){var o,l;const{nullable:a,extra:r}=t;return this.updateColumnSql({table:e,...t,isNotNull:a!="YES",isAutoIncrement:(l=(o=r==null?void 0:r.toLowerCase())==null?void 0:o.includes)==null?void 0:l.call(o,"auto_increment")})}updateColumnSql(e){const{table:t,name:a,columnName:r=a,type:o,unsigned:l,zerofill:E,useCurrentTimestamp:u,isNotNull:T,isAutoIncrement:A,comment:N,defaultValue:_,character_set_name:M,collation_name:w}=e,D=!Te(o)&&!o.match(/json/i);return new S(`ALTER TABLE \`${t}\``).append(`
	CHANGE \`${r}\` \`${a}\` ${o}`).if(l=="1","UNSIGNED").if(E=="1","ZEROFILL").if(u,"ON UPDATE CURRENT_TIMESTAMP").if(D&&M,`CHARACTER SET ${M}`).if(D&&w,`COLLATE ${w}`).if(T,"NOT NULL").if(A,"AUTO_INCREMENT").if(N,`COMMENT '${N}'`).if(g(_)&&!T,"DEFAULT NULL").if(!g(_),`DEFAULT ${_=="CURRENT_TIMESTAMP"?_:`${B(_,o)}`}`).append(";").toString()}showCollations(){return'select DEFAULT_COLLATE_NAME "name",CHARACTER_SET_NAME "charset",DESCRIPTION "description" from information_schema.CHARACTER_SETS ORDER BY name;'}showChecks(e,t){return`SELECT
    ...
    WHERE
        ...
        AND tc.CONSTRAINT_NAME = cc.CONSTRAINT_NAME;`}showUsers(){return"SELECT user user,host host FROM mysql.user;"}pingDataBase(e){return e?`use \`${e}\``:"select 1"}updateTable(e){const{table:t,newTableName:a,comment:r,newComment:o,collation:l,newCollation:E}=e;let u="";return o&&o!=r&&(u=`ALTER TABLE \`${t}\` COMMENT = '${o}';`),E&&E!=l&&(u+=`ALTER TABLE \`${t}\` collate = '${E}';`),a&&t!=a&&(u+=`ALTER TABLE \`${t}\` RENAME TO \`${a}\`;`),u}truncateDatabase(e){return`SELECT Concat('TRUNCATE TABLE \`',table_schema,'\`.\`',TABLE_NAME, '\`;') trun FROM INFORMATION_SCHEMA.TABLES where  table_schema ='${e}' and TABLE_TYPE<>'VIEW';`}createDatabase(e){return`CREATE DATABASE $1
...
END;`}}class ge extends ie{showVersion(){return"select replace(@@version,'-MariaDB','') server_version;"}}class De extends F{showVersion(){return"show version"}showDatabases(){return"show dbs"}buildPageSql(e,t,a){return`db('${e}').collection('${t}').find({}).limit(${a}).toArray()`}pingDataBase(e){return null}dropIndex(e,t){throw new Error("Method not implemented.")}updateColumnSql(e){throw new Error("Method not implemented.")}showIndex(e,t){return`db('${e}').collection('${t}').indexes();`}createIndex(e){const{database:t,table:a,column:r}=e;return`db('${t}').collection('${a}').createIndex({ ${r||"column_name"}: 1 });`}createDatabase(e){return'db("db_name").createCollection("collection")'}showSchemas(){throw new Error("Method not implemented.")}updateTable(e){throw new Error("Method not implemented.")}updateColumn(e,t){throw new Error("Method not implemented.")}showTables(e){throw new Error("Method not implemented.")}addColumn(e,t){throw new Error("Method not implemented.")}showColumns(e,t){throw new Error("Method not implemented.")}showViews(e){throw new Error("Method not implemented.")}showSystemViews(e){throw new Error("Method not implemented.")}showUsers(){throw new Error("Method not implemented.")}createUser(){throw new Error("Method not implemented.")}showTriggers(e){throw new Error("Method not implemented.")}showProcedures(e){throw new Error("Method not implemented.")}showFunctions(e){throw new Error("Method not implemented.")}truncateDatabase(e){throw new Error("Method not implemented.")}showTableSource(e,t){throw new Error("Method not implemented.")}showViewSource(e,t){throw new Error("Method not implemented.")}showProcedureSource(e,t){throw new Error("Method not implemented.")}showFunctionSource(e,t){throw new Error("Method not implemented.")}showTriggerSource(e,t){throw new Error("Method not implemented.")}tableTemplate(){throw new Error("Method not implemented.")}viewTemplate(){throw new Error("Method not implemented.")}procedureTemplate(){throw new Error("Method not implemented.")}triggerTemplate(){throw new Error("Method not implemented.")}functionTemplate(){throw new Error("Method not implemented.")}processList(){throw new Error("Method not implemented.")}variableList(){throw new Error("Method not implemented.")}statusList(){throw new Error("Method not implemented.")}dropTriggerTemplate(e){throw new Error("Method not implemented.")}}class Ue extends F{showVersion(){return"SELECT CAST(SERVERPROPERTY('ProductVersion') AS SYSNAME)+' '+CAST(SERVERPROPERTY('Edition') AS SYSNAME) AS server_version"}createIndex(e){return`ALTER TABLE ${e.table} ADD ${e.type} (${e.column})`}dropIndex(e,t){return`DROP INDEX ${e}.${t}`}showIndex(e,t){return`SELECT
    ...
    ADD $1 [type]$2;`}createUser(){return"CREATE LOGIN [name] WITH PASSWORD = 'password';"}updateColumn(e,t){const{name:a,type:r,comment:o,nullable:l,defaultValue:E}=t,u=l=="YES"?"NULL":"NOT NULL";return`-- change column type
ALTER TABLE ${e} 
    ALTER COLUMN ${a} ${r} ${u};
-- change column name
EXEC sp_rename '${e}.${a}', '${a}', 'COLUMN';`}updateColumnSql(e){const{columnName:t,columnType:a,newColumnName:r,comment:o,isNotNull:l,schema:E,table:u}=e,T=l?"NOT NULL":"NULL";return new S(`ALTER TABLE "${E}"."${u}" ALTER COLUMN ${t} ${a} ${T};`,`
`).if(t!=r,()=>`EXEC sp_rename '${E}.${u}.${t}' , '${r}', 'COLUMN';`).toString()}showUsers(){return"SELECT name [user] from sys.database_principals where type='S'"}updateTable(e){const{database:t,table:a,newTableName:r}=e;return`sp_rename '${a}', '${r}'`}truncateDatabase(e){return`SELECT Concat('TRUNCATE TABLE [',table_schema,'].[',TABLE_NAME, '];') trun FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_TYPE = 'BASE TABLE'  AND TABLE_SCHEMA='${e}'`}createDatabase(e){return`create database ${e||"[name]"}`}showTableSource(e,t){return""}showViewSource(e,t){return`SELECT definition 'Create View' FROM sys.sql_modules WHERE object_id = OBJECT_ID('${e}.${t}');`}showProcedureSource(e,t){return`SELECT definition 'Create Procedure','${e}.${t}' "Procedure" FROM sys.sql_modules WHERE object_id = OBJECT_ID('${e}.${t}');`}showFunctionSource(e,t){return`SELECT definition 'Create Function','${e}.${t}' "Function" FROM sys.sql_modules WHERE object_id = OBJECT_ID('${e}.${t}');`}showTriggerSource(e,t){return`SELECT definition 'SQL Original Statement','${e}.${t}' "Trigger" FROM sys.sql_modules WHERE object_id = OBJECT_ID('${e}.${t}');`}showColumns(e,t){return["information_schema","sys"].includes(e==null?void 0:e.toLowerCase())?`SELECT
            name,
...
GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA public TO $1;`}updateUser(e){return`ALTER USER ${e} WITH PASSWORD 'new_password';`}updateColumn(e,t){const{name:a,type:r,comment:o,nullable:l,defaultValue:E}=t;return`-- change column type
ALTER TABLE ${e} 
    ALTER COLUMN ${a} TYPE ${r};
-- change column name
ALTER TABLE ${e} 
...
COMMENT ON COLUMN ${e}.${a} IS '${o||"comment"}';`}updateColumnSql(e){return new Re(e).genAlterSQL()}showUsers(){return'SELECT usename "user" from pg_user '}showForeignKeys(e,t){return`SELECT
  ...
  ORDER BY ord_position;`}pingDataBase(e){return e?`set search_path to '${e}';`:"select 1"}updateTable(e){const{table:t,newTableName:a,comment:r,newComment:o}=e;let l="";return o&&o!=r&&(l=`COMMENT ON TABLE "${t}" IS '${o}';`),a&&t!=a&&(l+=`ALTER TABLE "${t}" RENAME TO "${a}";`),l}truncateDatabase(e){return`SELECT Concat('TRUNCATE TABLE "',TABLE_NAME, '";') trun FROM INFORMATION_SCHEMA.TABLES WHERE  table_schema ='${e}' AND table_type='BASE TABLE';`}createDatabase(e){return"CREATE DATABASE $1"}showTableSource(e,t){return""}showViewSource(e,t,a){return a.isMaterial()?`SELECT CONCAT('CREATE MATERIALIZED VIEW ',matviewname,'
AS
...
GRANT ALL PRIVILEGES ON *.* TO '$1'@'%' WITH GRANT OPTION;`}updateUser(e){return`update mysql.user set 
    ...
    where User = '${e}';
FLUSH PRIVILEGES;
-- since mysql version 5.7, password column need change to authentication_string=PASSWORD("newPassword")`}updateColumn(e,t){var _;const{name:a,type:r,comment:o,nullable:l,defaultValue:E,extra:u,character_set_name:T,collation_name:A}=t,N=l!="YES";return new S(`ALTER TABLE ${e}`).append(`
	CHANGE ${a} ${a} ${r}`).if(T,`CHARACTER SET ${T}`).if(A,`COLLATE ${A}`).if(N,"NOT NULL").if((_=u==null?void 0:u.toLowerCase())==null?void 0:_.includes("auto_increment"),"AUTO_INCREMENT").if(o,`COMMENT '${o}'`).if(g(E)&&!N,"DEFAULT NULL").if(!g(E),`DEFAULT ${E=="CURRENT_TIMESTAMP"?E:`'${Se(E)}'`}`).toString()}updateColumnSql(e){const{table:t,columnName:a,newColumnName:r,columnType:o,isNotNull:l,isAutoIncrement:E,comment:u,defaultValue:T,oldRow:A}=e,N=`ALTER TABLE "${t}"`,_=l?"SET NOT NULL":"DROP NOT NULL";return new S(`${N} ALTER COLUMN "${a}" TYPE ${o};`,`
`).if(u&&u!=A.comment,`${N} ALTER COLUMN "${a}" COMMENT '${u}';`).if(l!=A.isNotNull,`${N} ALTER COLUMN "${a}" ${_};`).if(a!=r,`${N} RENAME COLUMN "${a}" TO "${r}";`).toString()}showCollations(){return""}showChecks(e,t){return""}showUsers(){return"SELECT user user,host host FROM mysql.user;"}pingDataBase(e,t){return e?`use "${t}"."${e}"`:"select 1"}updateTable(e){const{table:t,newTableName:a,comment:r,newComment:o,collation:l,newCollation:E}=e;let u="";return o&&o!=r&&(u=`ALTER TABLE \`${t}\` COMMENT = '${o}';`),E&&E!=l&&(u+=`ALTER TABLE \`${t}\` collate = '${E}';`),a&&t!=a&&(u+=`ALTER TABLE \`${t}\` RENAME TO \`${a}\`;`),u}truncateDatabase(e){return`SELECT Concat('TRUNCATE TABLE \`',table_schema,'\`.\`',TABLE_NAME, '\`;') trun FROM INFORMATION_SCHEMA.TABLES where  table_schema ='${e}' and TABLE_TYPE<>'VIEW';`}createDatabase(e){return`CREATE DATABASE $1
...
-- change column name
ALTER TABLE ${e} 
    RENAME COLUMN ${a} TO ${a};`}updateColumnSql(e){return new oe(e).genAlterSQL()}}class Pe extends j{showVersion(){return"select version() as server_version;"}showDatabases(){return"show databases"}showTables(e,t){return`show tables in ${e}`}showColumns(e,t){return`describe ${e}.${t};`}showViews(e,t){return`show views in ${e}`}}class ve extends j{showVersion(){return"SELECT node_version as server_version FROM system.runtime.nodes;"}pingDataBase(e){return e?`use ${e}`:"select 1"}showDatabases(){return"show catalogs"}}class ke extends j{showVersion(){return"SELECT cql_version as server_version FROM system.local;"}showUsers(){return'SELECT role as "user" FROM system_auth.roles;'}pingDataBase(e){return e?`use ${e}`:"select 1"}createDatabase(e){return`CREATE KEYSPACE $1
WITH REPLICATION = { 
...
FLUSH PRIVILEGES;
-- since mysql version 5.7, password column need change to authentication_string=PASSWORD("newPassword")`}updateColumn(e,t){var o,l;const{nullable:a,extra:r}=t;return this.updateColumnSql({table:e,...t,isNotNull:a!="YES",isAutoIncrement:(l=(o=r==null?void 0:r.toLowerCase())==null?void 0:o.includes)==null?void 0:l.call(o,"auto_increment")})}updateColumnSql(e){const{table:t,name:a,columnName:r=a,type:o,unsigned:l,zerofill:E,useCurrentTimestamp:u,isNotNull:T,isAutoIncrement:A,comment:N,defaultValue:_,character_set_name:M,collation_name:w}=e,D=!Te(o)&&!o.match(/json/i);return new S(`ALTER TABLE \`${t}\``).append(`
	CHANGE \`${r}\` \`${a}\` ${o}`).if(l=="1","UNSIGNED").if(E=="1","ZEROFILL").if(u,"ON UPDATE CURRENT_TIMESTAMP").if(D&&M,`CHARACTER SET ${M}`).if(D&&w,`COLLATE ${w}`).if(T,"NOT NULL").if(A,"AUTO_INCREMENT").if(N,`COMMENT '${N}'`).if(g(_)&&!T,"DEFAULT NULL").if(!g(_),`DEFAULT ${_=="CURRENT_TIMESTAMP"?_:`${B(_,o)}`}`).append(";").toString()}showCollations(){return null}showChecks(e,t){return`SELECT
        tc.CONSTRAINT_NAME "name",
        cc.CHECK_CLAUSE "clause"
    FROM
        information_schema.CHECK_CONSTRAINTS AS cc,
...
PARTITION_NAME "name",PARTITION_METHOD "strategy",PARTITION_EXPRESSION "columnName",
PARTITION_DESCRIPTION "value",TABLE_ROWS "rows",DATA_LENGTH "length"
        FROM information_schema.partitions WHERE TABLE_SCHEMA='${e}' AND TABLE_NAME = '${t}' AND PARTITION_NAME IS NOT NULL`}showViewSource(e,t){return`SHOW CREATE VIEW  \`${e}\`.\`${t}\`;`}showProcedureSource(e,t){return`SHOW CREATE PROCEDURE \`${e}\`.\`${t}\`;`}showFunctionSource(e,t){return`SHOW CREATE FUNCTION \`${e}\`.\`${t}\`;`}showTriggerSource(e,t){return`SHOW CREATE TRIGGER \`${e}\`.\`${t}\`;`}showColumns(e,t,a){return`desc ${t}`}showForeignKeys(e,t){return`SELECT
        c.COLUMN_NAME column_name, ik.CONSTRAINT_NAME constraint_name,
        ik.REFERENCED_TABLE_NAME referenced_table, ik.REFERENCED_COLUMN_NAME referenced_column,
        UPDATE_RULE "updateRule",
        DELETE_RULE "deleteRule"
...
BEGIN
    $3
    return 0;
END;`}}function Ge(n){switch(n||(n=d.MYSQL),n){case null:case d.MYSQL:return new ie;case d.MARIA_DB:return new ge;case d.DORIS:return new Ye;case d.MSSQL:return new Ue;case d.libSQL:case d.SQLITE:return new pe;case d.DUCK_DB:return new He;case d.REDSHIFT:return new Be;case d.SNOWFLAKE:return new Fe;case d.PG:return new Ce;case d.CLICKHOUSE:return new Ie;case d.DM:return new fe;case d.ORACLE:return new Ne;case d.CASSANDRA:return new ke;case d.PRESTO:case d.TRINO:return new ve;case d.HIVE:return new Pe;case d.DB2:return new xe;case d.MONGO_DB:return new De;case d.NEO4J:return new ye;case d.TDengine:return new We}return new j}class k{constructor(e){this.meta=e,this.dialect=Ge(e.dbType),this.wrappedTable=v(this.meta.table,this.meta.dbType,$e.Always)}updateTable(e){return this.dialect.updateTable(e)}columnTypes(){return["INTEGER",{label:"VARCHAR",value:"VARCHAR(255)"},{label:"CHAR",value:"CHAR(50)"},"hr","DATE","TIMESTAMP","hr","BOOLEAN","FLOAT","DOUBLE","hr","TEXT","JSON","BLOB"]}strategys(){return["RESTRICT","CASCADE","SET NULL","SET DEFAULT","NO ACTION"]}newColumn(e){const{name:t,type:a,isNotNull:r}=e,o=r?" NOT NULL":"";return`ALTER TABLE ${this.wrappedTable} ADD COLUMN ${v(t,this.meta.dbType)} ${a}${o}`}updateColumn(e){return this.dialect.updateColumnSql({...e,table:this.meta.table,schema:this.meta.schema})}dropColumn(e){return`ALTER TABLE ${this.wrappedTable} DROP COLUMN ${v(e,this.meta.dbType)}`}formatIndexType(e){return e.index_type}indexTypes(){return[{label:"INDEX",value:"INDEX"},{label:"UNIQUE",value:"UNIQUE"}]}dropIndex(e){return this.dialect.dropIndex(this.wrappedTable,e)}showChecks(){return this.dialect.showChecks(this.meta.schema,this.meta.table)}showForeignKeys(){return this.dialect.showForeignKeys(this.meta.schema,this.meta.table)}newForeignKey(e){const{column:t,foreignKeyName:a,refTable:r,refColumn:o,onUpdate:l,onDelete:E}=e,u=l=="NO ACTION"?"":` ON UPDATE ${l}`,T=E=="NO ACTION"?"":` ON DELETE ${E}`;return new S(`ALTER TABLE "${this.meta.table}"`).if(a,()=>`ADD CONSTRAINT ${a}`).if(!a,"ADD").append(`FOREIGN KEY ("${t}") REFERENCES "${r}"("${o}")${u}${T};`).toString()}dropForeignKey(e){return`ALTER TABLE "${this.meta.table}" DROP CONSTRAINT ${e};`}newCheck(e){return`ALTER TABLE ${this.wrappedTable} ADD CHECK (${e});`}dropCheck(e){return`ALTER TABLE ${this.wrappedTable} DROP CONSTRAINT ${e};`}splitColumn(e,t='"'){return e.map(a=>t+a+t).join(",")}}class qe extends k{columnTypes(){return["Int32","String","Float32","hr","Date","DateTime","hr","BOOLEAN","UUID",{label:"Array",value:"Array(String)"},"hr","JSON",{label:"Tuple",value:"Tuple(String)"},{label:"Map",value:"Map(String,String)"}]}newColumn(e){const{name:t,type:a,defaultValue:r,comment:o}=e;return new S(`ALTER TABLE ${this.wrappedTable} ADD COLUMN "${t}" ${a}`).if(!g(r),`DEFAULT ${B(r,a)}`).if(o,`COMMENT '${o}'`).toString()}newIndex(e){const{columns:t}=e;return`ALTER TABLE "${this.meta.table}" ADD INDEX ${t.join("")}_${new Date().getTime()}_index expression TYPE type GRANULARITY value AFTER ${this.splitColumn(t)}`}showForeignKeys(){return null}showChecks(){return null}}class Ee extends k{newColumn(e){const{name:t,type:a,defaultValue:r,isNotNull:o}=e;return new S(`ALTER TABLE "${this.meta.schema}".${v(this.meta.table,this.meta.dbType)} ADD ${v(t,this.meta.dbType)} ${a}`).if(o,"NOT NULL").if(!g(r),`DEFAULT ${B(r,a)}`).toString()}dropColumn(e){return`ALTER TABLE "${this.meta.schema}".${this.wrappedTable} DROP COLUMN ${v(e,this.meta.dbType)}`}newIndex(e){const{table:t=this.meta.table,columns:a,type:r}=e,o=`${t}_${a.join("_")}_${new Date().getTime()}`;return`CREATE ${r=="UNIQUE"?"UNIQUE":""} INDEX ${o} ON "${this.meta.schema}"."${t}"(${this.splitColumn(a)});`}newCheck(e){return`ALTER TABLE "${this.meta.schema}".${this.wrappedTable} ADD CHECK (${e});`}dropCheck(e){return`ALTER TABLE "${this.meta.schema}".${this.wrappedTable} DROP CONSTRAINT ${e};`}dropForeignKey(e){return`ALTER TABLE "${this.meta.schema}"."${this.meta.table}" DROP CONSTRAINT ${e};`}newForeignKey(e){return super.newForeignKey(e).replace(`"${this.meta.table}"`,`"${this.meta.schema}"."${this.meta.table}"`)}}class Ke extends k{indexTypes(){return[{label:"INDEX",value:"INDEX"},{label:"UNIQUE",value:"UNIQUE"},{label:"FULLTEXT",value:"FULLTEXT"}]}columnTypes(){return["INT",{label:"VARCHAR",value:"VARCHAR(255)"},{label:"CHAR",value:"CHAR(50)"},"hr","DATETIME","TIMESTAMP","DATE","hr","BIT","FLOAT","DOUBLE",{label:"DECIMAL",value:"DECIMAL(10,2)"},"BIGINT","hr","TEXT","JSON","BLOB","BINARY","hr",{label:"ENUM",value:"ENUM('item')"},{label:"SET",value:"SET('item')"}]}newColumn(e){const{name:t,type:a,comment:r,defaultValue:o,isNotNull:l,unsigned:E,zerofill:u}=e;return console.log(e),new S(`ALTER TABLE ${this.wrappedTable} ADD COLUMN \`${t}\` ${a}`).if(E&&E!=0,"UNSIGNED").if(u,"ZEROFILL").if(l,"NOT NULL").if(r,`COMMENT '${r}'`).if(!g(o),`DEFAULT ${B(o,a)}`).toString()}formatIndexType(e){const t=e.index_type.toUpperCase();return t=="BTREE"?e.index_name=="PRIMARY"?"PRIMARY":de(e.isUnique)?"UNIQUE":"KEY":t}newIndex(e){const{type:t="key",columns:a}=e;return`ALTER TABLE \`${this.meta.table}\` ADD ${t} (${this.splitColumn(a,"`")})`}newForeignKey(e){const{column:t,foreignKeyName:a,refTable:r,refColumn:o,onUpdate:l,onDelete:E}=e,u=l=="NO ACTION"?"":` ON UPDATE ${l}`,T=E=="NO ACTION"?"":` ON DELETE ${E}`;return new S(`ALTER TABLE \`${this.meta.table}\``).if(a,()=>`ADD CONSTRAINT ${a}`).if(!a,"ADD").append(`FOREIGN KEY (\`${t}\`) REFERENCES \`${r}\`(\`${o}\`)${u}${T};`).toString()}dropForeignKey(e){return`ALTER TABLE \`${this.meta.table}\` DROP FOREIGN KEY ${e};`}}class je extends k{newIndex(e){const{table:t=this.meta.table,columns:a,type:r}=e,o=`${t}_${a.join("_")}_${new Date().getTime()}`;return`CREATE ${r=="UNIQUE"?"UNIQUE":""} INDEX ${o} ON "${t}"(${this.splitColumn(a)})`}newColumn(e){const{name:t,type:a,isNotNull:r,defaultValue:o,comment:l}=e;return new S(`ALTER TABLE ${v(this.meta.table,this.meta.dbType)} ADD ${t} ${a}`).if(!g(o),`DEFAULT ${B(o,a)}`).if(r,"NOT NULL").if(l,`;
COMMENT ON COLUMN ${this.wrappedTable}."${t.toUpperCase()}" is '${l}';`).toString()}newForeignKey(e){const{column:t,foreignKeyName:a,refTable:r,refColumn:o,onUpdate:l,onDelete:E}=e,u=l=="NO ACTION"?"":` ON UPDATE ${l}`,T=E=="NO ACTION"?"":` ON DELETE ${E}`,A=a||`${t}_${r}_${o}_fk_${Math.floor(Math.random()*30)}`;return`ALTER TABLE "${this.meta.table}" ADD CONSTRAINT ${A} FOREIGN KEY ("${t}") REFERENCES ${r}(${o})${u}${T};`}showForeignKeys(){var t;let{schema:e}=this.meta;return(e==null?void 0:e.toLowerCase())==((t=this.meta.user)==null?void 0:t.toLowerCase())&&(e=void 0),this.dialect.showForeignKeys(e,this.meta.table)}}class Qe extends k{newColumn(e){const{name:t,type:a,comment:r,defaultValue:o,isNotNull:l}=e,E=this.wrappedTable;return new S(`ALTER TABLE ${E} ADD COLUMN "${t}" ${a}`).if(l,"NOT NULL").if(!g(o),`DEFAULT ${B(o,a)}`).append(";").if(r,`
COMMENT ON COLUMN ${E}."${t}" is '${r}';`).toString()}columnTypes(){return["INTEGER",{label:"VARCHAR",value:"VARCHAR(255)"},{label:"CHAR",value:"CHAR(50)"},"TIMESTAMP","DATE","BOOLEAN","FLOAT","TEXT","JSON","BLOB"]}indexTypes(){return[{label:"INDEX",value:"INDEX"},{label:"UNIQUE",value:"UNIQUE"},{label:"HASH",value:"HASH"}]}newIndex(e){const{table:t=this.meta.table,columns:a,type:r}=e,o=r=="HASH"?"hash":"btree";return`CREATE ${r=="UNIQUE"?"UNIQUE":""} INDEX ${a.join("_")}_${new Date().getTime()}_index ON "${t}" USING ${o} (${this.splitColumn(a)});`}}class Xe extends k{newIndex(e){throw new Error("Method not implemented.")}dropForeignKey(e){return`ALTER TABLE "${this.meta.table}" DROP CONSTRAINT "${e}";`}showForeignKeys(){return`select
...
from information_schema.referential_constraints rco
    ...
    ORDER BY rco.CREATED`}}class ze extends k{newIndex(e){const{table:t=this.meta.table,columns:a}=e;return`CREATE INDEX ${`${t}_${a.join("_")}_${new Date().getTime()}`} ON "${t}"(${this.splitColumn(a)});`}showForeignKeys(){return`SELECT "from" column_name, "table" referenced_table, "to" referenced_column,
        on_update, on_delete 
        FROM pragma_foreign_key_list('${this.meta.table}');`}showChecks(){return null}}class Je extends k{newColumn(e){const{type:t,defaultValue:a}=e;return new S(super.newColumn(e)).if(!g(a),`DEFAULT ${B(a,t)}`).toString()}newIndex(e){const{table:t=this.meta.table,columns:a}=e;return`CREATE INDEX ${`${t}_${a.join("_")}_${new Date().getTime()}`} ON "${t}"(${this.splitColumn(a)});`}showForeignKeys(){return`SELECT constraint_column_names "column_name" FROM duckdb_constraints()
        WHERE constraint_type='FOREIGN KEY' and database_name not in ('system','temp') and schema_name='${this.meta.schema}' and table_name='${this.meta.table}'`}showChecks(){return null}}class Ze extends Ee{}class et extends Ee{columnTypes(){return["INTEGER","TEXT","hr","DATE","TIMESTAMP","hr","BOOLEAN","FLOAT","DOUBLE","hr","BLOB"]}dropColumn(e){return`ALTER TABLE ${this.wrappedTable} DROP ${v(e,this.meta.dbType)}`}}function Q(n){switch(n.dbType){case d.PG:case d.REDSHIFT:return new Qe(n);case d.DM:case d.ORACLE:return new je(n);case d.DB2:return new Ze(n);case d.CASSANDRA:return new et(n);case d.MSSQL:return new Ee(n);case d.SNOWFLAKE:return new Xe(n);case d.CLICKHOUSE:return new qe(n);case d.DUCK_DB:return new Je(n);case d.SQLITE:return new ze(n);case d.MYSQL:case d.MARIA_DB:default:return new Ke(n)}}const W=he("design",{state:()=>({dbType:d.MYSQL,schema:"",table:"",columns:[]}),getters:{canAlterTable(n){return![d.SQLITE].includes(n.dbType)},supportForeignKey(n){return![d.CLICKHOUSE].includes(n.dbType)},supportCheck(n){return![d.SQLITE,d.DUCK_DB,d.CLICKHOUSE,d.SNOWFLAKE].includes(n.dbType)},supportIndex(n){return![d.SNOWFLAKE].includes(n.dbType)}},actions:{updateDBType(n){this.dbType=n},updateFullInfo(n){for(const e in n)this[e]=n[e]}}}),tt={components:{codemirror:q},mixins:[V],props:["remainHeight","activePanel"],data(){return{indexes:[],indexTypes:[],dbType:null,columns:[],dialect:null,loading:!0,index:{visible:!1,loading:!1,column:null,type:null}}},computed:{...G(W,["canAlterTable"]),previewSQL(){var n;return((n=this.index.columns)==null?void 0:n.length)>0?this.dialect.newIndex({...this.index}):""}},mounted(){this.on("designMeta",n=>{const{columns:e,dbType:t}=n;this.columns=e,this.dbType=t,this.dialect=Q(n),this.indexTypes=this.dialect.indexTypes(),this.loadIndexes()}).on("columns",n=>{this.columns=n}).on("indexes",n=>{this.indexes=n,this.loading=!1}).on("success",n=>{n=="index"&&(this.index.loading=!1,this.index.visible=!1,this.loadIndexes())}).on("error",n=>{this.index.loading=!1})},methods:{loadIndexes(){this.emit("indexes"),this.loading=!0},openIndexDialog(){this.index={visible:!0,loading:!1,column:null,type:"INDEX"}},getIndexType(n){return this.dialect.formatIndexType(n)},formatUnique(n){return de(n)},doCreate(){this.index.loading=!0,this.emit("execute",{type:"index",sql:this.previewSQL})},deleteConfirm(n){J.confirm(this.$t("design.deleteIndexConfirm"),"Warning",{confirmButtonText:this.$t("common.ok"),cancelButtonText:this.$t("common.cancel"),type:"warning"}).then(()=>{this.emit("execute",{type:"index",sql:this.dialect.dropIndex(n.index_name)})})}}},nt={class:"design-toolbar"},at={class:"text-center"},rt=C("br",null,null,-1),ot=C("br",null,null,-1);function lt(n,e,t,a,r,o){const l=O("vsc-button"),E=Z,u=Ae,T=ee,A=O("RedMark"),N=le,_=se,M=te,w=ne,D=O("codemirror"),U=ae,Y=K;return m(),h("div",null,[C("div",nt,[["ClickHouse"].includes(r.dbType)?p("",!0):(m(),R(l,{key:0,type:"icon",icon:"codicon-add text-base",title:n.$t("common.new"),onClick:o.openIndexDialog},null,8,["title","onClick"])),i(l,{type:"icon",icon:"codicon-refresh text-base",title:n.$t("common.refresh"),onClick:o.loadIndexes},null,8,["title","onClick"])]),t.activePanel=="index"?f((m(),R(T,{key:0,data:r.indexes,height:t.remainHeight,border:""},{default:c(()=>[i(E,{resizable:!0,align:"center",prop:"index_name",label:n.$t("design.indexName"),width:"200"},null,8,["label"]),i(E,{resizable:!0,align:"center",prop:"column_name",label:n.$t("design.column"),width:"200"},null,8,["label"]),i(E,{align:"center",prop:"isUnique",label:n.$t("design.unique"),width:"200"},{default:c(({row:s})=>[i(u,{disabled:"","model-value":o.formatUnique(s.isUnique)},null,8,["model-value"])]),_:1},8,["label"]),i(E,{resizable:!0,align:"center",prop:"index_type",label:n.$t("common.type"),width:"200"},{default:c(({row:s})=>[L(b(o.getIndexType(s)),1)]),_:1},8,["label"]),["PostgreSQL"].includes(r.dbType)?(m(),R(E,{key:0,resizable:!0,align:"center",prop:"index_method",label:n.$t("design.indexMethod"),width:"200"},null,8,["label"])):p("",!0),["ClickHouse"].includes(r.dbType)?p("",!0):(m(),R(E,{key:1,label:n.$t("design.operation"),width:"120"},{default:c(({row:s})=>[C("div",at,[i(l,{type:"icon",icon:"codicon-remove",title:"delete",onClick:$=>o.deleteConfirm(s)},null,8,["onClick"])])]),_:1},8,["label"]))]),_:1},8,["data","height"])),[[Y,r.loading]]):p("",!0),i(U,{modelValue:r.index.visible,"onUpdate:modelValue":e[3]||(e[3]=s=>r.index.visible=s),title:n.$t("design.newIndex"),width:"520px",closeOnClickModal:!1,center:""},{footer:c(()=>[i(l,{type:"secondary",onClick:e[2]||(e[2]=s=>r.index.visible=!1)},{default:c(()=>[L(b(n.$t("common.cancel")),1)]),_:1}),i(l,{type:"primary",loading:r.index.loading,onClick:o.doCreate},{default:c(()=>[L(b(n.$t("common.ok")),1)]),_:1},8,["loading","onClick"]),rt,L(),ot,f(i(D,{ref:"cmEditor",value:o.previewSQL},null,8,["value"]),[[P,o.previewSQL]])]),default:c(()=>[i(w,{inline:!0,"label-width":"75px",size:"small"},{default:c(()=>[i(M,null,{label:c(()=>[i(A),L(b(n.$t("design.column")),1)]),default:c(()=>[i(_,{modelValue:r.index.columns,"onUpdate:modelValue":e[0]||(e[0]=s=>r.index.columns=s),size:"small",filterable:"",multiple:"",class:"!w-[150px]"},{default:c(()=>[(m(!0),h(y,null,H(r.columns,s=>(m(),R(N,{key:s.name,label:s.name,value:s.name},null,8,["label","value"]))),128))]),_:1},8,["modelValue"])]),_:1}),i(M,null,{label:c(()=>[i(A),L(b(n.$t("common.type")),1)]),default:c(()=>[i(_,{modelValue:r.index.type,"onUpdate:modelValue":e[1]||(e[1]=s=>r.index.type=s),size:"small",class:"!w-[110px]"},{default:c(()=>[(m(!0),h(y,null,H(r.indexTypes,(s,$)=>(m(),R(N,{key:$,label:s.label,value:s.value},null,8,["label","value"]))),128))]),_:1},8,["modelValue"])]),_:1})]),_:1})]),_:1},8,["modelValue","title"])])}const st=x(tt,[["render",lt]]),it={components:{codemirror:q},mixins:[V],props:["activePanel"],data(){return{loading:!1,ddl:"",dbType:"",user:null}},mounted(){this.on("ddl",({ddl:n,dbType:e})=>{this.dbType=e,this.loading=!1,this.ddl=n}).on("user",n=>{this.user=n,this.emit("ddl"),this.loading=!0}).emit("user")},methods:{copyDDL(){navigator.clipboard.writeText(this.ddl),_e("Copy DDL success!")}}},Et={ref:"infoPanel",class:"design-toolbar"};function ut(n,e,t,a,r,o){const l=O("vsc-button"),E=O("codemirror"),u=K;return f((m(),h("div",null,[C("div",Et,[i(l,{type:"icon",icon:"el-icon-document-copy text-base",title:"Copy DDL",onClick:o.copyDDL},null,8,["onClick"]),i(l,{type:"icon",icon:"codicon-refresh text-base",title:n.$t("common.refresh"),onClick:e[0]||(e[0]=T=>n.emit("ddl"))},null,8,["title"])],512),t.activePanel=="ddl"?(m(),R(E,{key:0,dbType:r.dbType,value:r.ddl},null,8,["dbType","value"])):p("",!0)])),[[u,r.loading]])}const ct=x(it,[["render",ut]]),mt={components:{codemirror:q},mixins:[V],props:["remainHeight","activePanel"],data(){return{foreignKeys:[],dbType:null,tables:[],curTableColumns:[],columns:[],strategys:[],dialect:null,loading:!0,status:{visible:!1,loading:!1},editModel:{column:null,refTable:null,refColumn:null,onUpdate:"NO ACTION",onDelete:"NO ACTION"}}},computed:{...G(W,["canAlterTable"]),previewSQL(){const{column:n,refTable:e,refColumn:t}=this.editModel;return n||e||t?this.dialect.newForeignKey(this.editModel):""}},mounted(){this.on("designMeta",n=>{const{columns:e,dbType:t}=n;this.columns=e,this.dbType=t,this.dialect=Q(n),this.strategys=this.dialect.strategys(),this.loadForeignKeys(),this.emit("tables")}).on("columns",n=>{this.columns=n}).on("foreignKeys",n=>{this.loading=!1,this.foreignKeys=n}).on("columnsById",n=>{this.editModel.refColumn="",this.curTableColumns=n}).on("success",n=>{n=="fk"&&(this.status.loading=!1,this.status.visible=!1,this.loadForeignKeys())}).on("error",()=>{this.status.loading=!1}).on("tables",n=>{this.tables=n})},methods:{getColumns(n){this.emit("columnsById",n)},loadForeignKeys(){const n=this.dialect.showForeignKeys();n&&(this.loading=!0,this.emit("foreignKeys",n))},openFkDialog(){this.status={visible:!0,loading:!1},this.editModel={column:null,refTable:null,refColumn:null,onUpdate:"NO ACTION",onDelete:"NO ACTION"}},doCreate(){this.status.loading=!0,this.emit("execute",{type:"fk",sql:this.previewSQL})},deleteConfirm(n){J.confirm(this.$t("design.deleteFkConfirm"),"Warning",{confirmButtonText:this.$t("common.ok"),cancelButtonText:this.$t("common.cancel"),type:"warning"}).then(()=>{this.emit("execute",{type:"fk",sql:this.dialect.dropForeignKey(n.constraint_name)})})}}},Tt={key:0,class:"design-toolbar"},dt={class:"text-center"},At=C("br",null,null,-1),_t=C("br",null,null,-1),Nt=C("br",null,null,-1);function Rt(n,e,t,a,r,o){const l=O("vsc-button"),E=Z,u=ee,T=O("RedMark"),A=le,N=se,_=te,M=re,w=ne,D=O("codemirror"),U=ae,Y=K;return m(),h("div",null,[n.canAlterTable?(m(),h("div",Tt,[i(l,{type:"icon",icon:"codicon-add text-base",title:n.$t("common.new"),onClick:o.openFkDialog},null,8,["title","onClick"]),i(l,{type:"icon",icon:"codicon-refresh text-base",title:n.$t("common.refresh"),onClick:o.loadForeignKeys},null,8,["title","onClick"])])):p("",!0),t.activePanel=="foreignKey"?f((m(),R(u,{key:1,data:r.foreignKeys,style:{width:"100%"},height:t.remainHeight,border:""},{default:c(()=>[n.canAlterTable?(m(),R(E,{key:0,resizable:!0,align:"center",prop:"constraint_name",label:n.$t("design.constraintName"),width:"150"},null,8,["label"])):p("",!0),i(E,{resizable:!0,align:"center",prop:"column_name",label:n.$t("design.column"),width:"150"},null,8,["label"]),i(E,{resizable:!0,align:"center",prop:"referenced_table",label:n.$t("design.referencedTable"),width:"150"},null,8,["label"]),i(E,{resizable:!0,align:"center",prop:"referenced_column",label:n.$t("design.referencedColumn"),width:"150"},null,8,["label"]),i(E,{align:"center",prop:"updateRule",label:n.$t("design.updateRule"),width:"150"},null,8,["label"]),i(E,{align:"center",prop:"deleteRule",label:n.$t("design.deleteRule"),width:"150"},null,8,["label"]),n.canAlterTable?(m(),R(E,{key:1,label:n.$t("design.operation"),width:"120"},{default:c(({row:s})=>[C("div",dt,[i(l,{type:"icon",icon:"codicon-remove",title:"delete",onClick:$=>o.deleteConfirm(s)},null,8,["onClick"])])]),_:1},8,["label"])):p("",!0)]),_:1},8,["data","height"])),[[Y,r.loading]]):p("",!0),i(U,{modelValue:r.status.visible,"onUpdate:modelValue":e[7]||(e[7]=s=>r.status.visible=s),title:n.$t("design.newForeignKey"),width:"780px",closeOnClickModal:!1,center:""},{footer:c(()=>[i(l,{type:"secondary",onClick:e[6]||(e[6]=s=>r.status.visible=!1)},{default:c(()=>[L(b(n.$t("common.cancel")),1)]),_:1}),i(l,{type:"primary",loading:r.status.loading,onClick:o.doCreate},{default:c(()=>[L(b(n.$t("common.ok")),1)]),_:1},8,["loading","onClick"]),_t,L(),Nt,f(i(D,{ref:"cmEditor",value:o.previewSQL},null,8,["value"]),[[P,o.previewSQL]])]),default:c(()=>[i(w,{inline:!0,"label-width":"150px","label-position":"left",size:"small"},{default:c(()=>[i(_,null,{label:c(()=>[i(T),L(b(n.$t("design.column")),1)]),default:c(()=>[i(N,{modelValue:r.editModel.column,"onUpdate:modelValue":e[0]||(e[0]=s=>r.editModel.column=s),size:"small",filterable:"",class:"!w-[170px] mr-4"},{default:c(()=>[(m(!0),h(y,null,H(r.columns,s=>(m(),R(A,{key:s.name,label:s.name,value:s.name},null,8,["label","value"]))),128))]),_:1},8,["modelValue"])]),_:1}),[].includes(r.dbType)?p("",!0):(m(),R(_,{key:0,label:n.$t("design.foreignKeyName")},{default:c(()=>[i(M,{modelValue:r.editModel.foreignKeyName,"onUpdate:modelValue":e[1]||(e[1]=s=>r.editModel.foreignKeyName=s),class:"!w-[170px]"},null,8,["modelValue"])]),_:1},8,["label"])),At,i(_,null,{label:c(()=>[i(T),L(b(n.$t("design.referencedTable")),1)]),default:c(()=>[i(N,{modelValue:r.editModel.refTable,"onUpdate:modelValue":e[2]||(e[2]=s=>r.editModel.refTable=s),size:"small",filterable:"",class:"!w-[170px] mr-4"},{default:c(()=>[(m(!0),h(y,null,H(r.tables,s=>(m(),R(A,{key:s.name,label:s.name,value:s.name,onClick:$=>o.getColumns(s.id)},null,8,["label","value","onClick"]))),128))]),_:1},8,["modelValue"])]),_:1}),i(_,null,{label:c(()=>[i(T),L(b(n.$t("design.referencedColumn")),1)]),default:c(()=>[i(N,{modelValue:r.editModel.refColumn,"onUpdate:modelValue":e[3]||(e[3]=s=>r.editModel.refColumn=s),size:"small",filterable:"",class:"!w-[170px]"},{default:c(()=>[(m(!0),h(y,null,H(r.curTableColumns,s=>(m(),R(A,{key:s.name,label:s.name,value:s.name},null,8,["label","value"]))),128))]),_:1},8,["modelValue"])]),_:1}),i(_,{label:"On Update"},{default:c(()=>[i(N,{modelValue:r.editModel.onUpdate,"onUpdate:modelValue":e[4]||(e[4]=s=>r.editModel.onUpdate=s),size:"small",filterable:"",class:"!w-[170px] mr-4"},{default:c(()=>[(m(!0),h(y,null,H(r.strategys,s=>(m(),R(A,{key:s,label:s,value:s},null,8,["label","value"]))),128))]),_:1},8,["modelValue"])]),_:1}),i(_,{label:"On Delete"},{default:c(()=>[i(N,{modelValue:r.editModel.onDelete,"onUpdate:modelValue":e[5]||(e[5]=s=>r.editModel.onDelete=s),size:"small",filterable:"",class:"!w-[170px]"},{default:c(()=>[(m(!0),h(y,null,H(r.strategys,s=>(m(),R(A,{key:s,label:s,value:s},null,8,["label","value"]))),128))]),_:1},8,["modelValue"])]),_:1})]),_:1})]),_:1},8,["modelValue","title"])])}const Ct=x(mt,[["render",Rt]]),pt={components:{codemirror:q},mixins:[V],props:["remainHeight","activePanel"],data(){return{table:null,dbType:null,typeSelector:{visible:!1,inputing:!1},types:[],typeSelectorVisible:!1,columnLoading:!0,columns:[],copyedColumns:[],dialect:null,editColumn:{name:"",type:"",unsigned:null,zerofill:null,defaultValue:null,useCurrentTimestamp:null},column:{isNew:!0,editVisible:!1,editLoading:!1}}},computed:{...G(W,["canAlterTable"]),supportUnsigned(){var n,e;return this.isMySQL&&((e=(n=this.editColumn.type)==null?void 0:n.match)==null?void 0:e.call(n,/(int|decimal|float|double)/i))},mysqlTimestamp(){var n,e;return this.isMySQL&&((e=(n=this.editColumn.type)==null?void 0:n.match)==null?void 0:e.call(n,/timestamp/i))},isSmall(){return window.innerWidth<=1200},isMySQL(){return["MySQL","MariaDB"].includes(this.dbType)},tilte(){const n=this.column.isNew?"design.newColumn":"design.updateColumn";return this.$t(n)},filterTypes(){return this.typeSelector.inputing&&this.editColumn.type?this.types.filter(n=>(n.label||n).match(new RegExp(this.editColumn.type,"i"))):this.types},previewSQL(){if(this.column.isNew){const{name:n,type:e}=this.editColumn;return n&&e?this.dialect.newColumn(this.editColumn):""}return this.supportUnsigned||(this.editColumn.zerofill=!1,this.editColumn.unsigned=!1),this.mysqlTimestamp||(this.editColumn.useCurrentTimestamp=!1),this.dialect.updateColumn({table:this.table,newColumnName:this.editColumn.name,columnType:this.editColumn.type,nullable:!this.editColumn.isNotNull,...this.editColumn,type:Me(this.editColumn)})},supportChangeIncrement(){return[d.MYSQL,d.MARIA_DB,d.PG,d.DB2].includes(this.dbType)}},mounted(){this.on("designMeta",n=>{this.columns=n.columns,this.copyedColumns=me.clone(n.columns),this.dbType=n.dbType,this.columnLoading=!1,this.dialect=Q(n),this.types=this.dialect.columnTypes()}).on("columns",n=>{this.columns=n,this.copyedColumns=me.clone(n),this.columnLoading=!1}).on("success",n=>{n=="column"&&(this.column.editLoading=!1,this.column.editVisible=!1,this.loadColumns())}).on("error",()=>{this.column.editLoading=!1,this.loadColumns()})},methods:{not(...n){return!n.includes(this.dbType)},updateUseCurrentTimestamp(n){n&&(this.editColumn.defaultValue="CURRENT_TIMESTAMP")},selectType(){const n=this.filterTypes[0];n&&(this.editColumn.type=n.value||n,this.typeSelector.visible=!1)},loadColumns(){this.emit("columns"),this.columnLoading=!0},newColumn(){this.editColumn={name:"",type:""},this.column.isNew=!0,this.column.editVisible=!0},openEdit(n){this.editColumn={...n,columnName:n.name,oldRow:n},this.column.isNew=!1,this.column.editVisible=!0,this.column.editLoading=!1},changeColumn(n,e){this.column.isNew=!1,this.editColumn={...n,columnName:n.name,oldRow:this.copyedColumns[e]},this.updateColumn()},updateColumn(){if(!this.previewSQL)return z("No any change!");if(this.column.editLoading=!0,this.column.isNew)return this.doCreate();try{this.emit("execute",{type:"column",sql:this.previewSQL})}catch(n){z(n.message),this.column.editLoading=!1}},doCreate(){this.emit("execute",{type:"column",sql:this.previewSQL})},deleteConfirm(n){J.confirm(this.$t("design.deleteColumnConfirm"),"Warning",{confirmButtonText:this.$t("common.ok"),cancelButtonText:this.$t("common.cancel"),type:"warning"}).then(()=>{this.emit("execute",{type:"column",sql:this.dialect.dropColumn(n.name)})})}}},ue=n=>(be("data-v-e249d759"),n=n(),Le(),n),ht={key:0,ref:"infoPanel",class:"design-toolbar"},bt=["title"],Lt={class:"text-center"},Ot=ue(()=>C("br",null,null,-1)),St={class:"max-h-[300px]"},Mt=["onClick"],$t=ue(()=>C("br",null,null,-1)),wt=ue(()=>C("br",null,null,-1));function It(n,e,t,a,r,o){const l=O("vsc-button"),E=Z,u=Ae,T=ee,A=O("RedMark"),N=re,_=te,M=we,w=ne,D=O("codemirror"),U=ae,Y=K;return m(),h("div",null,[n.canAlterTable?(m(),h("div",ht,[i(l,{type:"icon",icon:"codicon-add text-base",title:n.$t("common.new"),onClick:o.newColumn},null,8,["title","onClick"]),i(l,{type:"icon",icon:"codicon-refresh text-base",title:n.$t("common.refresh"),onClick:o.loadColumns},null,8,["title","onClick"])],512)):p("",!0),t.activePanel=="column"?f((m(),R(T,{key:1,data:r.columns,height:t.remainHeight,onRowDblclick:o.openEdit,border:""},{default:c(()=>[i(E,{resizable:!0,align:"center",prop:"name",label:n.$t("common.name"),width:"180"},null,8,["label"]),i(E,{resizable:!0,align:"center",prop:"type",label:n.$t("common.type"),width:o.isSmall?100:130},null,8,["label","width"]),["DuckDB"].includes(r.dbType)?p("",!0):(m(),R(E,{key:0,resizable:!0,align:"center",prop:"comment",label:n.$t("common.comment"),width:"100"},{default:c(({row:s})=>[C("span",{title:s==null?void 0:s.comment},b(s==null?void 0:s.comment),9,bt)]),_:1},8,["label"])),i(E,{resizable:!0,align:"center",prop:"maxLength",width:80,label:n.$t("design.length")},null,8,["label"]),i(E,{resizable:!0,align:"center",prop:"defaultValue",width:o.isSmall?75:110,label:n.$t("common.default")},null,8,["width","label"]),i(E,{align:"center",label:"Not Null",width:80},{default:c(({row:s,rowIndex:$})=>[i(u,{modelValue:s.isNotNull,"onUpdate:modelValue":I=>s.isNotNull=I,onChange:I=>o.changeColumn(s,$)},null,8,["modelValue","onUpdate:modelValue","onChange"])]),_:1}),i(E,{align:"center",label:n.$t("design.isPrimary"),width:o.isSmall?80:90},{default:c(({row:s})=>[i(u,{disabled:"","model-value":s.isPrimary},null,8,["model-value"])]),_:1},8,["label","width"]),i(E,{align:"center",label:n.$t("design.isUnique"),width:o.isSmall?60:80},{default:c(({row:s})=>[i(u,{disabled:"","model-value":s.isUnique},null,8,["model-value"])]),_:1},8,["label","width"]),o.isMySQL?(m(),h(y,{key:1},[i(E,{align:"center",label:"UNSIGNED",width:"80"},{default:c(({row:s,rowIndex:$})=>[i(u,{modelValue:s.unsigned,"onUpdate:modelValue":I=>s.unsigned=I,"true-value":"1","false-value":"0",onChange:I=>o.changeColumn(s,$)},null,8,["modelValue","onUpdate:modelValue","onChange"])]),_:1}),i(E,{align:"center",label:"Zerofill",width:o.isSmall?60:80},{default:c(({row:s,rowIndex:$})=>[i(u,{modelValue:s.zerofill,"onUpdate:modelValue":I=>s.zerofill=I,"true-value":"1","false-value":"0",onChange:I=>o.changeColumn(s,$)},null,8,["modelValue","onUpdate:modelValue","onChange"])]),_:1},8,["width"])],64)):p("",!0),["DuckDB"].includes(r.dbType)?p("",!0):(m(),R(E,{key:2,align:"center",label:n.$t("design.isAutoIncrement"),width:"110"},{default:c(({row:s,rowIndex:$})=>[i(u,{modelValue:s.isAutoIncrement,"onUpdate:modelValue":I=>s.isAutoIncrement=I,disabled:!s.isPrimary||!o.supportChangeIncrement,onChange:I=>o.changeColumn(s,$)},null,8,["modelValue","onUpdate:modelValue","disabled","onChange"])]),_:1},8,["label"])),["SQLite"].includes(r.dbType)?p("",!0):(m(),R(E,{key:3,label:n.$t("design.operation"),width:"100"},{default:c(({row:s,rowIndex:$})=>[C("div",Lt,[i(l,{type:"icon",icon:"codicon-edit",title:"edit",onClick:I=>o.openEdit(s,$)},null,8,["onClick"]),i(l,{type:"icon",icon:"codicon-remove",title:"delete",onClick:I=>o.deleteConfirm(s)},null,8,["onClick"])])]),_:1},8,["label"]))]),_:1},8,["data","height","onRowDblclick"])),[[Y,r.columnLoading]]):p("",!0),i(U,{modelValue:r.column.editVisible,"onUpdate:modelValue":e[12]||(e[12]=s=>r.column.editVisible=s),title:o.tilte,width:"680px",closeOnClickModal:!1,center:""},{footer:c(()=>[i(l,{type:"secondary",onClick:e[11]||(e[11]=s=>r.column.editVisible=!1)},{default:c(()=>[L(b(n.$t("common.cancel")),1)]),_:1}),i(l,{type:"primary",loading:r.column.editLoading,onClick:o.updateColumn},{default:c(()=>[L(b(n.$t("common.ok")),1)]),_:1},8,["loading","onClick"]),$t,L(),wt,f(i(D,{ref:"cmEditor",value:o.previewSQL},null,8,["value"]),[[P,o.previewSQL]])]),default:c(()=>[i(w,{inline:!0,"label-width":"90px",size:"small"},{default:c(()=>[i(_,null,{label:c(()=>[i(A),L(b(n.$t("common.name")),1)]),default:c(()=>[i(N,{modelValue:r.editColumn.name,"onUpdate:modelValue":e[0]||(e[0]=s=>r.editColumn.name=s),size:"small",fixed:""},null,8,["modelValue"])]),_:1}),o.supportUnsigned?(m(),R(_,{key:0,label:"ZEROFILL"},{default:c(()=>[i(u,{modelValue:r.editColumn.zerofill,"onUpdate:modelValue":e[1]||(e[1]=s=>r.editColumn.zerofill=s),"true-value":"1","false-value":"0"},null,8,["modelValue"])]),_:1})):p("",!0),o.mysqlTimestamp?(m(),R(_,{key:1,label:"CURRENT_TIMESTAMP","label-width":"160px"},{default:c(()=>[i(u,{modelValue:r.editColumn.useCurrentTimestamp,"onUpdate:modelValue":e[2]||(e[2]=s=>r.editColumn.useCurrentTimestamp=s),onChange:o.updateUseCurrentTimestamp},null,8,["modelValue","onChange"])]),_:1})):p("",!0),Ot,i(_,null,{label:c(()=>[i(A),L(b(n.$t("common.type")),1)]),default:c(()=>[i(M,{modelValue:r.typeSelector.visible,"onUpdate:modelValue":e[6]||(e[6]=s=>r.typeSelector.visible=s),placement:"bottom-start","popper-class":"!p-0",trigger:"click",tabindex:null},{reference:c(()=>[i(N,{modelValue:r.editColumn.type,"onUpdate:modelValue":e[3]||(e[3]=s=>r.editColumn.type=s),size:"small",fixed:"",onKeyup:X(o.selectType,["enter"]),onInput:e[4]||(e[4]=s=>{r.typeSelector.inputing=!0,r.typeSelector.visible=!0}),onClick:e[5]||(e[5]=s=>r.typeSelector.inputing=!1)},null,8,["modelValue","onKeyup"])]),default:c(()=>[C("div",St,[(m(!0),h(y,null,H(o.filterTypes,(s,$)=>(m(),h(y,null,[s=="hr"?(m(),h("div",{key:$,class:"w-full type-hr bg-bg"})):(m(),h("div",{key:1,class:"el-select-dropdown__item !h-6 min-w-[190px] bg-[var(--vscode-dropdown-background)]",onClick:I=>{r.editColumn.type=s.value||s,r.typeSelector.visible=!1}},b(s.label||s),9,Mt))],64))),256))])]),_:1},8,["modelValue"])]),_:1}),o.not("ClickHouse")?(m(),R(_,{key:2,label:n.$t("design.isNotNull")},{default:c(()=>[i(u,{modelValue:r.editColumn.isNotNull,"onUpdate:modelValue":e[7]||(e[7]=s=>r.editColumn.isNotNull=s)},null,8,["modelValue"])]),_:1},8,["label"])):p("",!0),o.supportUnsigned?(m(),R(_,{key:3,label:"UNSIGNED"},{default:c(()=>[i(u,{modelValue:r.editColumn.unsigned,"onUpdate:modelValue":e[8]||(e[8]=s=>r.editColumn.unsigned=s),"true-value":"1","false-value":"0"},null,8,["modelValue"])]),_:1})):p("",!0),!["SqlServer","Snowflake"].includes(r.dbType)||r.column.isNew?(m(),R(_,{key:4,label:n.$t("common.default")},{default:c(()=>[i(N,{modelValue:r.editColumn.defaultValue,"onUpdate:modelValue":e[9]||(e[9]=s=>r.editColumn.defaultValue=s),size:"small",fixed:""},null,8,["modelValue"])]),_:1},8,["label"])):p("",!0),["SqlServer","DuckDB"].includes(r.dbType)?p("",!0):(m(),R(_,{key:5,label:n.$t("common.comment")},{default:c(()=>[i(N,{modelValue:r.editColumn.comment,"onUpdate:modelValue":e[10]||(e[10]=s=>r.editColumn.comment=s),size:"small",fixed:""},null,8,["modelValue"])]),_:1},8,["label"]))]),_:1})]),_:1},8,["modelValue","title"])])}const ft=x(pt,[["render",It],["__scopeId","data-v-e249d759"]]),gt={mixins:[V],data(){return{dialect:null,collations:[],table:{name:null,newTableName:null,comment:null,newComment:null,collation:null,newCollation:null}}},mounted(){this.on("designMeta",n=>{this.table.name=n.table,this.table.newTableName=n.table,this.table.comment=n.comment,this.table.newComment=n.comment,this.table.collation=n.collation,this.table.newCollation=n.collation,this.dialect=Q(n)}).on("collations",n=>{this.collations=n})},methods:{updateTableMeta(){const n={...this.table,table:this.table.name};this.emit("updateTable",n);const e=this.dialect.updateTable(n);e?this.emit("execute",{type:"table",sql:e}):z("No any change!")}}},Dt={class:"ml-4"},Ut={class:"flex flex-col gap-y-2"},yt={class:"flex-wrap"},Bt={class:"inline-block mr-5"},Ft={class:"font-bold mr-5 inline-block"},Ht={class:"inline-block mr-5"},Pt={class:"font-bold mr-5 inline-block"},vt={class:"flex-wrap"},kt={key:0,class:"inline-block mr-5"},Vt={class:"font-bold mr-5 inline-block"},xt={class:"inline-block pt-1"};function Yt(n,e,t,a,r,o){const l=re,E=le,u=se,T=O("vsc-button");return m(),h("div",Dt,[C("div",Ut,[C("div",yt,[C("div",Bt,[C("label",Ft,b(n.$t("design.table")),1),i(l,{modelValue:r.table.newTableName,"onUpdate:modelValue":e[0]||(e[0]=A=>r.table.newTableName=A),class:"!w-48",required:"",onKeyup:X(o.updateTableMeta,["enter"])},null,8,["modelValue","onKeyup"])]),C("div",Ht,[C("label",Pt,b(n.$t("common.comment")),1),i(l,{modelValue:r.table.newComment,"onUpdate:modelValue":e[1]||(e[1]=A=>r.table.newComment=A),class:"!w-48",onKeyup:X(o.updateTableMeta,["enter"])},null,8,["modelValue","onKeyup"])])]),C("div",vt,[r.table.collation!=null&&r.collations.length>0?(m(),h("div",kt,[C("label",Vt,b(n.$t("design.collate")),1),i(u,{modelValue:r.table.newCollation,"onUpdate:modelValue":e[2]||(e[2]=A=>r.table.newCollation=A),size:"small",filterable:""},{default:c(()=>[(m(!0),h(y,null,H(r.collations,A=>(m(),R(E,{key:A.name,label:A.name,value:A.name},null,8,["label","value"]))),128))]),_:1},8,["modelValue"])])):p("",!0),C("div",xt,[i(T,{type:"success",onClick:o.updateTableMeta},{default:c(()=>[L(b(n.$t("common.update")),1)]),_:1},8,["onClick"])])])])])}const Wt=x(gt,[["render",Yt]]),Gt={components:{codemirror:q},mixins:[V],props:["remainHeight","activePanel"],data(){return{tableList:[],dbType:null,columns:[],dialect:null,loading:!0,status:{visible:!1,loading:!1},editModel:{clause:null}}},computed:{...G(W,["canAlterTable"]),previewSQL(){return this.editModel.clause?this.dialect.newCheck(this.editModel.clause):""}},mounted(){this.on("designMeta",n=>{const{columns:e,dbType:t}=n;this.columns=e,this.dbType=t,this.dialect=Q(n),this.loadData()}).on("checks",n=>{this.loading=!1,this.tableList=n}).on("success",n=>{n=="check"&&(this.loadData(),this.status.visible=!1,this.status.loading=!1)}).on("error",n=>{this.status.loading=!1})},methods:{loadData(){const n=this.dialect.showChecks();if(!n){console.log("This database type does not currently support check."),this.loading=!1;return}this.loading=!0,this.emit("checks",n)},openDialog(){this.status={visible:!0,loading:!1},this.editModel={clause:null}},doCreate(){this.status.loading=!0,this.emit("execute",{type:"check",sql:this.previewSQL})},deleteConfirm(n){J.confirm(this.$t("design.deleteCheckConfirm"),"Warning",{confirmButtonText:this.$t("common.ok"),cancelButtonText:this.$t("common.cancel"),type:"warning"}).then(()=>{this.emit("execute",{type:"check",sql:this.dialect.dropCheck(n.name)})})}}},qt={key:0,class:"design-toolbar"},Kt={class:"text-center"},jt=C("br",null,null,-1),Qt=C("br",null,null,-1);function Xt(n,e,t,a,r,o){const l=O("vsc-button"),E=Z,u=ee,T=O("RedMark"),A=re,N=te,_=ne,M=O("codemirror"),w=ae,D=K;return m(),h("div",null,[n.canAlterTable?(m(),h("div",qt,[i(l,{type:"icon",icon:"codicon-add text-base",title:n.$t("common.new"),onClick:o.openDialog},null,8,["title","onClick"]),i(l,{type:"icon",icon:"codicon-refresh text-base",title:n.$t("common.refresh"),onClick:o.loadData},null,8,["title","onClick"])])):p("",!0),t.activePanel=="check"?f((m(),R(u,{key:1,data:r.tableList,height:t.remainHeight,border:""},{default:c(()=>[n.canAlterTable?(m(),R(E,{key:0,resizable:!0,align:"center",prop:"name",label:n.$t("design.constraintName"),width:"200"},null,8,["label"])):p("",!0),i(E,{resizable:!0,align:"center",prop:"clause",label:n.$t("design.clause"),width:"200"},null,8,["label"]),n.canAlterTable?(m(),R(E,{key:1,label:n.$t("design.operation"),width:"100"},{default:c(({row:U})=>[C("div",Kt,[i(l,{type:"icon",icon:"codicon-remove",title:"delete",onClick:Y=>o.deleteConfirm(U)},null,8,["onClick"])])]),_:1},8,["label"])):p("",!0)]),_:1},8,["data","height"])),[[D,r.loading]]):p("",!0),i(w,{modelValue:r.status.visible,"onUpdate:modelValue":e[3]||(e[3]=U=>r.status.visible=U),title:n.$t("design.newCheck"),width:"430px",closeOnClickModal:!1,center:""},{footer:c(()=>[i(l,{type:"secondary",onClick:e[2]||(e[2]=U=>r.status.visible=!1)},{default:c(()=>[L(b(n.$t("common.cancel")),1)]),_:1}),i(l,{type:"primary",loading:r.status.loading,onClick:o.doCreate},{default:c(()=>[L(b(n.$t("common.ok")),1)]),_:1},8,["loading","onClick"]),jt,L(),Qt,f(i(M,{ref:"cmEditor",value:o.previewSQL},null,8,["value"]),[[P,o.previewSQL]])]),default:c(()=>[i(_,{inline:!0,"label-width":"80px","label-position":"left",onSubmit:e[1]||(e[1]=Oe(()=>{},["prevent"])),onKeyup:X(o.doCreate,["enter"])},{default:c(()=>[i(N,null,{label:c(()=>[i(T),L(b(n.$t("design.clause")),1)]),default:c(()=>[i(A,{modelValue:r.editModel.clause,"onUpdate:modelValue":e[0]||(e[0]=U=>r.editModel.clause=U),class:"!w-[290px]",size:"small",placeholder:"e.g. id >20 and name!='admin'"},null,8,["modelValue"])]),_:1})]),_:1},8,["onKeyup"])]),_:1},8,["modelValue","title"])])}const zt=x(Gt,[["render",Xt]]),Jt={components:{IndexPanel:st,ColumnPanel:ft,InfoPanel:Wt,ForeignKey:Ct,Check:zt,DDL:ct},mixins:[V],data(){return{remainHeight:0,panels:[{id:"ddl",i18n:"design.ddl",icon:"codicon-edit green"},{id:"column",i18n:"design.column",icon:"codicon-symbol-field blue"},{id:"foreignKey",i18n:"design.foreignKey",icon:"codicon-symbol-class yellow",hidden:()=>!this.supportForeignKey},{id:"index",i18n:"design.index",icon:"codicon-github-action purple",hidden:()=>!this.supportIndex},{id:"check",i18n:"design.check",icon:"codicon-tools orange",hidden:()=>!this.supportCheck}],activePanel:"column"}},computed:{...G(W,["canAlterTable","supportForeignKey","supportIndex","supportCheck"]),computedPanels(){return this.panels.filter(n=>{var e;return((e=n==null?void 0:n.hidden)==null?void 0:e.call(n))!=!0})}},mounted(){const n=W();this.on("dbType",a=>{n.updateDBType(a)}).on("designMeta",a=>{n.updateFullInfo(a)}).on("success",()=>{_e(this.$t("design.updateSuccess"))}).on("error",a=>{z(a)}).on("refresh_design",()=>{this.init()}),this.init(),window.addEventListener("focus",()=>{this.init()});const e=this.$refs.infoPanel,t=()=>{var r;const a=((r=document.getElementById("tableTab"))==null?void 0:r.clientHeight)||0;this.remainHeight=window.innerHeight-55-e.clientHeight-a};t(),new ResizeObserver(t).observe(e),addEventListener("resize",t)},methods:{init(){this.emit("init",{type:"design"})}}},Zt={class:"mt-2 design-container"},en={ref:"infoPanel"},tn={class:"tab"},nn=["onClick"],an={class:"design-data-container"};function rn(n,e,t,a,r,o){const l=O("InfoPanel"),E=O("ColumnPanel"),u=O("ForeignKey"),T=O("IndexPanel"),A=O("Check"),N=O("DDL");return m(),h("div",Zt,[C("div",en,[i(l),C("ul",tn,[(m(!0),h(y,null,H(o.computedPanels,(_,M)=>(m(),h("li",{key:M,class:ce(["tab__item",{"tab__item--active":r.activePanel==_.id}]),onClick:w=>r.activePanel=_.id},[_.icon?(m(),h("i",{key:0,type:"icon",class:ce(_.icon),style:{position:"relative",top:"3px"}},null,2)):p("",!0),L(" "+b(n.$t(_.i18n)),1)],10,nn))),128))])],512),C("div",an,[f(i(E,{remainHeight:r.remainHeight,activePanel:r.activePanel},null,8,["remainHeight","activePanel"]),[[P,r.activePanel=="column"]]),f(i(u,{remainHeight:r.remainHeight,activePanel:r.activePanel},null,8,["remainHeight","activePanel"]),[[P,r.activePanel=="foreignKey"]]),f(i(T,{remainHeight:r.remainHeight,activePanel:r.activePanel},null,8,["remainHeight","activePanel"]),[[P,r.activePanel=="index"]]),f(i(A,{remainHeight:r.remainHeight,activePanel:r.activePanel},null,8,["remainHeight","activePanel"]),[[P,r.activePanel=="check"]]),f(i(N,{activePanel:r.activePanel},null,8,["activePanel"]),[[P,r.activePanel=="ddl"]])])])}const xn=x(Jt,[["render",rn],["__scopeId","data-v-d5df2669"]]);export{xn as default};
